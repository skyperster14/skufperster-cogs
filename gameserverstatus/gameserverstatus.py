    ...
    async def do_status_ss14(self, ctx: Messageable, cfgname: str, dat: Dict[str, str], embed: Embed) -> None:
        ...
        async with aiohttp.ClientSession() as session:
            ...
            if starttimestr:
                ...
                elif (delta.days % 10 == 2 or delta.days % 10 == 3 or delta.days % 10 == 4) and delta.days != 11 and delta.days != 12 and delta.days != 13 and delta.days != 14:
                    s.append(f"{delta.days} дня")
                else:
                ...
                if hours == 1 or hours % 10 == 1:
                    ...
                    minutes %= 60
                elif (hours % 10 == 2 or hours % 10 == 3 or hours % 10 == 4) and hours != 11 and hours != 12 and hours != 13 and hours != 14:
                    s.append(f"{hours} часа")
                    minutes %= 60
                else:
                ...
                elif (minutes % 10 == 2 or minutes % 10 == 3 or minutes % 10 == 4) and minutes != 11 and minutes != 12 and minutes != 13 and minutes != 14:
                    s.append(f"{minutes} минуты")
                else:
